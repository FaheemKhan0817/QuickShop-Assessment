...
def test_validate_orders_success():
    ...
    expected_cols = {"order_id", "order_date", "product_id", "qty", "unit_price", "user_id", "order_status"}
...
def test_enrich_orders_computation_and_filtering():
    ...
    assert enriched.loc[enriched["order_id"] == 60001, "product_name"].iloc[0] == "Classic Tee"
